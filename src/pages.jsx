          ...
          {!selectedReport ? (
            ...
            <>
              ...
              <div className="ncr-section">
                ...
                <label className="ncr-checkbox-line"><input type="checkbox" checked={selectedReport.containmentRequired} onChange={event => updateSelectedField({ containmentRequired: event.target.checked, lifecycleStage: event.target.checked ? 'containment_required' : selectedReport.lifecycleStage }, 'containment updated')} /> Immediate containment required</label>
                <textarea rows={3} defaultValue={selectedReport.containmentSummary || ''} onBlur={event => updateSelectedField({ containmentSummary: event.target.value }, 'containment summary updated')} placeholder="Immediate containment, hold, quarantine, communication, or customer protection steps..." />
          ...
          <div className="modal-content" style={{ width: 'min(96vw, 900px)', maxHeight: '88vh', overflowY: 'auto' }}>
            ...
            <div style={{ padding: 16 }}>
              ...
              <div style={{ display: 'grid', gap: 10, marginTop: 10 }}>
                ...
                <label className="ncr-checkbox-line"><input type="checkbox" checked={createDraft.containmentRequired} onChange={event => setCreateDraft(prev => ({ ...prev, containmentRequired: event.target.checked, lifecycleStage: event.target.checked ? 'containment_required' : prev.lifecycleStage }))} /> Immediate containment required</label>
