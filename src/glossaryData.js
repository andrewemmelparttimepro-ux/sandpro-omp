...
export const NCR_GLOSSARY = [
  ...
  },
  {
    ...
    terms: [
      ...
      { id: 'group', term: 'Group / Affected Departments', aka: ['Department Group'], def: 'The departments impacted by the event (Shop, Service, CP, Sales, Automation, ...). The first one listed is the primary group used in rollups and charts.' },
