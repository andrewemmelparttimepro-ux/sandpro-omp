...
test('NCR closure requires department manager and senior management agreement levels', () => {
  ...
  assert.match(pages, /Senior management review and agreement is required/);
  assert.match(pages, /<option value="department_manager">Department manager signoff<\/option>/);
  assert.match(pages, /<option value="executive">Senior management agreement<\/option>/);
