...
const checks = [
  ...
  ['assignment_groups table', 'assignment_groups', 'id,name,slug,description,is_active,created_by,updated_by,created_at,updated_at'],
  ['assignment_group_members table', 'assignment_group_members', 'group_id,user_id,created_by,created_at'],
  ['profile_managers table', 'profile_managers', 'employee_id,manager_id,created_by,created_at'],
  ...
  ['OKR project members table', 'okr_project_members', 'id,project_id,user_id,role,created_by,created_at'],
  ...
  ['ncr_import_revisions table', 'ncr_import_revisions', 'id,ncr_id,batch_id,report_number,action,previous_source_record,imported_source_record,created_by,created_at'],
